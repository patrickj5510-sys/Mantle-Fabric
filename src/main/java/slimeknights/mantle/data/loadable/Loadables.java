...
import slimeknights.mantle.util.ToolAction;
...
public class Loadables {
  ...
  /** Loader-neutral serialization of Forge's former named tool-action identifiers. */
  ...
  /* Tag keys. Dynamic registries such as enchantments are safe here because a TagKey only needs the registry key. */
